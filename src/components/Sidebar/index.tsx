...
function Sidebar() {
  ...
  const userProfile = useSelector(selectAuthUserProfile);
    ...
    >
      ...
      >
        <Flex position="absolute" transform="translateX(50%)" right={0} top='25%'>
          ...
          >
            <FontAwesomeIcon icon={isSidebarExpanded? faArrowLeft: faArrowRight}></FontAwesomeIcon>
          </IconButton>
        </Flex>
          ...
          <Flex direction="column">
            ...
            <Flex alignSelf="center" marginBottom={5}>
              <Box style={{ textAlign: "center" }}>
                ...
                <p style={{}}>
                  Hi {userProfile.given_name} {userProfile.family_name}
                </p>
              </Box>
            </Flex>
            <Flex className={styles["Sidebar--section"]} direction="column" alignItems={isSidebarExpanded? '': 'center'}>
